...
public:
	...
	LinkInfo(): localPort(0), remotePort(0) {};
};
...
{
	// CAUTION!!!
	// LinkMap DO NOT manage mem of pTask
public:

	void Add(SOCKET sd, CSharePtr<NetLinkTask>& spTask);
	void Remove(SOCKET sd);
private:
	std::map<SOCKET, CSharePtr<NetLinkTask>> mapLinks;
	CCriticalSection csLink;
};
